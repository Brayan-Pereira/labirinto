...
void desenha(int pX, int pY, int passos)
{
    ...
    cout << BRIGHT_CYAN << "========================================" << RESET << endl;
    cout << " Passos Totais: " << BRIGHT_YELLOW << passos << RESET << " | Visao: " << BRIGHT_GREEN << "3x3 ON" << RESET << endl
         << endl;
    ...
    for (int i = 0; i < LINHAS; i++)
    {
        for (int j = 0; j < COLUNAS; j++)
        {
            if (i == pY && j == pX)
                ...
                cout << BRIGHT_GREEN << "E" << RESET;
            else if (mapa[i][j] == '*')
                cout << BRIGHT_BLUE << "*" << RESET; // Ida (Azul)
            else if (mapa[i][j] == 'R')
                cout << PURPLE << "*" << RESET; // Volta (Roxo) - Mantém o símbolo '*'
            else
                cout << " ";
        }
        cout << endl;
    ...
    cout << endl
         << BRIGHT_CYAN << " CONTROLES: [W,A,S,D] | [U] Undo | [Q] Sair" << RESET << endl;
}
        ...
        else
        {
            ...
            if (nY >= 0 && nY < LINHAS && nX >= 0 && nX < COLUNAS && mapa[nY][nX] != '#')
            {
                ...
                if (mapa[pY][pX] == 'E')
                {
                    ...
                    cout << endl;
                    cout << BRIGHT_CYAN << " Desenvolvido por:" << RESET << endl;
